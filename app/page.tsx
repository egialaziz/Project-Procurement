  ...
  return (
    <div className="relative min-h-screen">
      ...
      <div className="fixed inset-0 -z-50">
        <img
          src="/P_20250612_084221.jpg" // Pastikan path ini benar
          alt="Background"
      ...
      <main className="relative z-10 flex flex-col items-center justify-center min-h-screen px-4">
        <div className="bg-white/90 backdrop-blur-md rounded-xl shadow-2xl p-8 max-w-md w-full text-center">
          ...
          <div className="flex flex-col gap-4">
            ...
            <Link
              href="/user/catalogue"
              className="bg-white border-2 border-orange-500 text-orange-500 font-semibold py-3 px-6 rounded-lg transition-all duration-300 hover:bg-orange-50"
            >
              User Catalogue View
            </Link>
          </div>
