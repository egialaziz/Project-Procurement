...
export default function Home() {
  return (
    <div className="relative min-h-screen">
      {/* Background Layer - Fixed positioning ensures it stays behind */}
      ...
      {/* Content Layer - Regular flow with higher z-index */}
      <main className="relative flex flex-col items-center justify-center min-h-screen px-4 py-12">
        <div className="bg-white/90 backdrop-blur-md rounded-xl shadow-2xl p-8 max-w-md w-full text-center border border-orange-100">
